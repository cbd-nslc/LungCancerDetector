...
from keras.layers import Input, Convolution3D, MaxPooling3D, \
    Flatten, Dropout, AveragePooling3D, Conv3D
...
def get_net(input_shape=(CUBE_SIZE, CUBE_SIZE, CUBE_SIZE, 1), load_weight_path=None, features=False,
    ...
    last64 = Conv3D(filters=64, kernel_size=(2, 2, 2), activation="relu", name="last_64")(x)
