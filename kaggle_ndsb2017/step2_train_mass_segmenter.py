...
from keras.layers import Input, Convolution2D, MaxPooling2D, UpSampling2D, BatchNormalization, Concatenate
...
def random_flip_img(img, horizontal_chance: float = 0, vertical_chance: float = 0):
    import cv2
