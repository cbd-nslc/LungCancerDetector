...
import collections
import random
from DSB2017.layers import iou
        ...
        if self.channel == 2:
            ...
            if 'cleanimg' in config and config['cleanimg']:
                ...
                for idx in idcs:
                    ...
                    self.filenames.append(os.path.join(data_dir, file_name))
        ...
        for idx in idcs:
            if config['luna_raw'] == True:
                try:
                    ...
                    file_name = os.path.splitext(idx)[0] + '_label.npy'
                    l = np.load(os.path.join(data_dir, file_name))
            else:
